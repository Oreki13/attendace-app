...
export const Login: React.FC<LoginProps> = ({ navigation }: AuthNavProp<'Login'>) => {
    const { login } = useContext(AuthContext)
    return (
        <>
            {/* <StatusBar backgroundColor='#000' /> */}
            <Center>
                <Image style={styles.image} source={require('../../../assets/images/finger_print_monochromatic.png')} />
                <View style={styles.boxTxtLogin}>
                    <Text style={styles.textLogin}>Welcome</Text>
                    <Text style={styles.textSubLogin}>Please insert your account</Text>
                </View>
                ...
                <View style={styles.boxReg}>
                    <Text style={styles.fontReg}>Dont't Have an account?</Text>
                    <Text onPress={() => navigation.navigate("Register")} style={styles.fontRegSignUp}> Sign Up.</Text>
                </View>
            </Center>
        </>
    );
